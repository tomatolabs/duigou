...
.up().item('ClassTypeStatus', 'ClassTypeStatus', '班级状态')
    .addChild('already','1', '已开课')
    .addChild('nAlready','2', '未开课')

.up().item('City', 'City', '所在城市')
    .addChild('Beijing','bj', '北京')
    .addChild('Shanghai','sh', '上海')
    .addChild('Guangzhou','gz', '广州')
    .addChild('Shenzhen','sz', '深圳')
    .addChild('Chongqing','cq', '重庆')
    .addChild('Dalian','dl', '大连')
